...
function run_failed_responses_chat_completion() {
    locust -f failed_responses.py --headless -u 20 -r 20 -H https://staging.litellm.ai/ -t 30 --csv load_test
}

function run_all_cache_hits_locust_test() {
    locust -f all_cache_hits.py --headless -u 20 -r 20 -H https://staging.litellm.ai/ -t 30 --csv load_test
}


function run_no_cache_hits_locust_test() {
    locust -f no_cache_hits.py --headless -u 20 -r 20 -H https://staging.litellm.ai/ -t 30 --csv load_test
}

function run_cache_off_locust_test() {
    locust -f no_cache.py --headless -u 20 -r 20 -H https://staging.litellm.ai/ -t 30 --csv load_test
}
